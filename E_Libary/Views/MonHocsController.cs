...
namespace E_Libary.Views
{
    public class MonHocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MaMon,TenMonHoc,GiangVien,MoTa,ToBoMon")] MonHoc monHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MaMon,TenMonHoc,GiangVien,MoTa,ToBoMon")] MonHoc monHoc)
        {
            if (ModelState.IsValid)
            {
